...
def microsoft_send_email(to: str, subject: str, body: str) -> dict:
    ...
    try:
        ...
        response = _graph_request("POST", "/me/sendMail", json=payload)
...
def microsoft_delete_email(message_id: str) -> dict:
    ...
    try:
        _graph_request("DELETE", f"/me/messages/{message_id}")
...
def microsoft_create_calendar_event(
    ...
    try:
        ...
        response = _graph_request("POST", "/me/events", json=payload)
